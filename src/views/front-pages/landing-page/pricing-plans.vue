  ...
  <div id="pricing-plan">
    <VContainer>
      <div class="pricing-plans">
        ...
        >
          <VChip label color="primary" class="mb-4"> Pricing Plans </VChip>
          <div
            class="d-flex align-center text-h3 mb-1 flex-wrap justify-center"
          >
            <div class="position-relative me-2">
              <h3 class="section-title">Tailored design plans</h3>
            </div>
            designed for you
          </div>
          ...
          <div class="position-relative">
            ...
            <div class="position-absolute pricing-plan-arrow d-md-flex d-none">
              <VImg
                ...
                height="42"
              />
              <div class="text-no-wrap font-weight-medium">Save 25%</div>
            </div>
          </div>
        </div>
        <VRow>
