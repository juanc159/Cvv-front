import{V as c,U as l}from"./index-DKkpZA-b.js";import{B as d}from"./constants-Csqy1jag.js";const h=e=>e==null||e===""?!0:!!(Array.isArray(e)&&e.length===0),u=e=>e==null,f=e=>Array.isArray(e)&&e.length===0,A=(e,n=null)=>{const t=e.split("/"),s=t[t.length-1],r=s.split("."),i=r[r.length-1];let a=n+"."+i;n==null&&(a=s);const o=document.createElement("a");o.href=e,o.target="_blank",o.setAttribute("download",a),document.body.appendChild(o),o.click(),document.body.removeChild(o)},b=e=>{const n=window.open("","_blank");if(n){const t=`
      <html>
        <head>
