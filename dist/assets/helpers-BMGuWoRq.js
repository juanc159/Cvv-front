import{ay as i}from"./index-Bn0zRJ3l.js";import{B as l}from"./constants-2GBt7OCP.js";const{toast:d}=i(),h=e=>e==null||e===""?!0:!!(Array.isArray(e)&&e.length===0),b=e=>e==null,f=e=>Array.isArray(e)&&e.length===0,u=(e,o=null)=>{const t=e.split("/"),a=t[t.length-1],c=a.split("."),s=c[c.length-1];let n=o+"."+s;o==null&&(n=a);const r=document.createElement("a");r.href=e,r.target="_blank",r.setAttribute("download",n),document.body.appendChild(r),r.click(),document.body.removeChild(r)},w=e=>{const o=window.open("","_blank");if(o){const t=`
      <html>
        <head>
