import{aV as i,V as l,U as d}from"./index-GuEEMK3o.js";import{B as m}from"./constants-2GBt7OCP.js";const{toast:p}=i(),b=e=>e==null||e===""?!0:!!(Array.isArray(e)&&e.length===0),f=e=>e==null,w=e=>Array.isArray(e)&&e.length===0,g=(e,o=null)=>{const t=e.split("/"),r=t[t.length-1],s=r.split("."),c=s[s.length-1];let n=o+"."+c;o==null&&(n=r);const a=document.createElement("a");a.href=e,a.target="_blank",a.setAttribute("download",n),document.body.appendChild(a),a.click(),document.body.removeChild(a)},y=e=>{const o=window.open("","_blank");if(o){const t=`
      <html>
        <head>
